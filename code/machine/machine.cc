...
//----------------------------------------------------------------------
// Machine::getTimeUsed 
// 	Return the time this page was last used. Returns -1 if the pageNo passed
//      was invalid. 
//----------------------------------------------------------------------
int Machine::getTimeUsed(int pageNo)
{
	if (pageNo <0 || pageNo >= NumPhysPages) return -1;

	else return this->lastUsed[pageNo]; 
